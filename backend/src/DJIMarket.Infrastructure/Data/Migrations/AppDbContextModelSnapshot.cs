...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("DJIMarket.Domain.Entities.Category", b =>
        {
            ...
            b.HasKey("Id"); b.HasIndex("Name").IsUnique(); b.ToTable("categories");
        });
        modelBuilder.Entity("DJIMarket.Domain.Entities.Customer", b =>
        {
            b.Property<Guid>("Id").ValueGeneratedNever().HasColumnType("uuid");
            b.Property<string>("Company").IsRequired().HasMaxLength(160).HasColumnType("character varying(160)");
            b.Property<string>("Name").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
            b.Property<string>("Segment").IsRequired().HasMaxLength(40).HasColumnType("character varying(40)");
            b.HasKey("Id"); b.HasIndex("Segment"); b.ToTable("customers");
        });
        modelBuilder.Entity("DJIMarket.Domain.Entities.Manager", b =>
        {
            b.Property<Guid>("Id").ValueGeneratedNever().HasColumnType("uuid");
            b.Property<string>("AvatarSeed").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)");
            b.Property<bool>("IsActive").HasColumnType("boolean");
            b.Property<string>("Name").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)");
            b.Property<string>("Position").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)");
            b.Property<string>("Team").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)");
            b.HasKey("Id"); b.HasIndex("IsActive", "Team"); b.ToTable("managers");
        });
        modelBuilder.Entity("DJIMarket.Domain.Entities.Product", b =>
        {
            b.Property<Guid>("Id").ValueGeneratedNever().HasColumnType("uuid");
            ...
            b.HasKey("Id"); b.HasIndex("CategoryId", "IsActive"); b.ToTable("products");
        });
        modelBuilder.Entity("DJIMarket.Domain.Entities.Sale", b =>
        {
            b.Property<Guid>("Id").ValueGeneratedNever().HasColumnType("uuid");
            b.Property<Guid>("CustomerId").HasColumnType("uuid");
            b.Property<Guid>("ManagerId").HasColumnType("uuid");
            b.Property<DateTimeOffset>("SoldAt").HasColumnType("timestamp with time zone");
            b.Property<string>("Status").IsRequired().HasMaxLength(20).HasColumnType("character varying(20)");
            b.HasKey("Id"); b.HasIndex("CustomerId"); b.HasIndex("ManagerId", "SoldAt", "Status"); b.HasIndex("SoldAt", "Status"); b.ToTable("sales");
        });
        modelBuilder.Entity("DJIMarket.Domain.Entities.SaleItem", b =>
        {
            b.Property<Guid>("Id").ValueGeneratedNever().HasColumnType("uuid");
            b.Property<decimal>("CostPrice").HasPrecision(18,2).HasColumnType("numeric(18,2)");
            ...
            b.HasKey("Id"); b.HasIndex("ProductId"); b.HasIndex("SaleId"); b.ToTable("sale_items");
        });
